...
const MovieSearchResult = ({moviesResults, onSelectMovie}: props) => {
    return (
        <div className="w-full max-h-[70vh] overflow-y-auto">
            <div className="sticky top-0 bg-gray-800 text-white py-3 px-4 font-semibold rounded-b z-5">
                <span>{moviesResults.length} résultats trouvés</span>
            </div>

            <div className="p-2">
                {moviesResults.length === 0 ? (
                    <div className="text-center py-8 text-gray-500 z-5">Aucun résultat trouvé</div>
                ) : (
